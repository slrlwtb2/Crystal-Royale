...
//{
    ...
    void Start()
        ...
        void Followblue()
        {
            ...
            real = new Vector3(this.transform.position.x, this.transform.position.y + this.transform.TransformVector(cameraOffset).y,this.transform.position.z + 10);
            cameraTransform.position = real;
            //cameraTransform.rotation = Quaternion.Inverse(Quaternion.identity);
